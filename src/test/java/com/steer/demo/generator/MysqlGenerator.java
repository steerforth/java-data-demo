package com.steer.demo.generator;
...
public class MysqlGenerator {
    ...
    private static String table="sys_session";                  //table名字
    private static String prefix="sys_";                     //table前缀
    private static String packageName="demo";    //文件路径
    private static String path = "H:/mybatis-plus-generator/"+packageName;
    private static String authorName="Steerforth";     //作者
...
//        tableFillList.add(new TableFill("update_time", FieldFill.UPDATE));
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new StrategyConfig()
                        ...
                        // 自定义实体父类
                        .setSuperEntityClass("com.steer.demo.common.model.BaseEntity")
                        // 自定义实体，公共字段
...
//                        .setSuperControllerClass("com.tdx."+packageName+".controller.AbstractController")
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.steer."+packageName)// 自定义包路径
